...
package org.apache.doris.connector.iceberg.backend.hms;
...
class HmsIcebergBackendFactoryTest {
    ...
    void factoryDiscoveredViaServiceLoader() {
        ...
        boolean present = found.stream()
                .anyMatch(f -> f instanceof HmsIcebergBackendFactory);
        Assertions.assertTrue(present,
                "ServiceLoader did not find HmsIcebergBackendFactory; got: " + found);
    }

    @Test
    void factoryNameMatchesBackendName() {
        HmsIcebergBackendFactory f = new HmsIcebergBackendFactory();
        Assertions.assertEquals("hms", f.name());
