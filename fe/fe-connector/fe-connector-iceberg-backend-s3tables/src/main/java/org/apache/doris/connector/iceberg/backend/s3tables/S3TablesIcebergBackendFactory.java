...
/** ServiceLoader entry point for the S3 Tables Iceberg backend. */
public final class S3TablesIcebergBackendFactory implements IcebergBackendFactory {

    @Override
    public String name() {
        return S3TablesIcebergBackend.NAME;
    }

    @Override
    public IcebergBackend create() {
        return new S3TablesIcebergBackend();
    }
}
