...
Status BloomFilterIndexReader::load(bool use_page_cache, bool kept_in_memory, int64_t* mem_footprint) {
    ...
    RETURN_IF_ERROR(_bloom_filter_reader->load(use_page_cache, kept_in_memory, mem_footprint));
    return Status::OK();
}
