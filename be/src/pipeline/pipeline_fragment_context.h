...
public:
    ...
    TUniqueId get_fragment_id() {
        return _fragment_id;
    }

    RuntimeState* get_runtime_state() {
    ...
    int32_t next_operator_template_id() {
        return _next_operator_template_id++;
    }
    ...
    void set_is_report_success(bool is_report_success) {
        _is_report_success = is_report_success;
    }

    ExecNode *&plan() { return _root_plan; }

    void set_need_wait_execution_trigger() {
        _need_wait_execution_trigger = true;
    }
