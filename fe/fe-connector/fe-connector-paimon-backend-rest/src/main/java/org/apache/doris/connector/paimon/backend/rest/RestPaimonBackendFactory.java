...
/** ServiceLoader entry point for the REST Paimon backend. */
public final class RestPaimonBackendFactory implements PaimonBackendFactory {

    @Override
    public String name() {
        return RestPaimonBackend.NAME;
    }

    @Override
    public PaimonBackend create() {
        return new RestPaimonBackend();
    }
}
