...
/** ServiceLoader entry point for the DLF Iceberg backend. */
public final class DlfIcebergBackendFactory implements IcebergBackendFactory {

    @Override
    public String name() {
        return DlfIcebergBackend.NAME;
    }

    @Override
    public IcebergBackend create() {
        return new DlfIcebergBackend();
    }
}
