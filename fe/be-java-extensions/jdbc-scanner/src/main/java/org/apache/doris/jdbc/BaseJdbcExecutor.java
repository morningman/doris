...
public abstract class BaseJdbcExecutor implements JdbcExecutor {
    ...
    public long getBlockAddress(int batchSize, Map<String, String> outputParams) throws JdbcExecutorException {
        try {
            ...
            // Construct the resultSetColumnMap, the column num in output table maybe less than
            // column num in resultSetMetaData. eg:
            // select c1 from query("catalog" = "ctl", "query" = "select c1,c2 from ctl.db");
