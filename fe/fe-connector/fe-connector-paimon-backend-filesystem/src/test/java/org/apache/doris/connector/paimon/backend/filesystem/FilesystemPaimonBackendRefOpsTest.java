...
/**
 * Verifies that {@link FilesystemPaimonBackend} inherits the shared paimon
 ...
 */
class FilesystemPaimonBackendRefOpsTest {
    ...
    private FilesystemPaimonBackend backend;
    ...
    void setUp() throws Exception {
        ...
        backend = new FilesystemPaimonBackend() {
            @Override
