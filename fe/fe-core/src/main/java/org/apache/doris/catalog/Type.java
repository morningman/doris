...
public abstract class Type {
    ...
    public boolean isDecimal32() {
        return isScalarType(PrimitiveType.DECIMAL32);
    }

    public boolean isDecimal64() {
        return isScalarType(PrimitiveType.DECIMAL64);
    }

    public boolean isDecimal128() {
        return isScalarType(PrimitiveType.DECIMAL128);
    }

    public boolean isDecimalV3() {
        return isScalarType(PrimitiveType.DECIMAL32) ||
            isScalarType(PrimitiveType.DECIMAL64) ||
    ...
    static {
        ...
        compatibilityMatrix[TINYINT.ordinal()][DECIMALV2.ordinal()] = PrimitiveType.DECIMAL128;
        ...
        compatibilityMatrix[SMALLINT.ordinal()][DECIMALV2.ordinal()] = PrimitiveType.DECIMAL128;
        ...
        compatibilityMatrix[INT.ordinal()][DECIMALV2.ordinal()] = PrimitiveType.DECIMAL128;
        ...
        compatibilityMatrix[BIGINT.ordinal()][DECIMALV2.ordinal()] = PrimitiveType.DECIMAL128;
        compatibilityMatrix[BIGINT.ordinal()][DECIMAL32.ordinal()] = PrimitiveType.DECIMAL32;
        ...
        compatibilityMatrix[LARGEINT.ordinal()][DECIMALV2.ordinal()] = PrimitiveType.DECIMAL128;
        ...
        for (int i = 0; i < PrimitiveType.values().length - 2; ++i) {
            for (int j = i; j < PrimitiveType.values().length - 2; ++j) {
                ...
                if (t1 == PrimitiveType.DECIMAL32 || t2 == PrimitiveType.DECIMAL32) continue;
                if (t1 == PrimitiveType.DECIMAL64 || t2 == PrimitiveType.DECIMAL64) continue;
                if (t1 == PrimitiveType.DECIMAL128 || t2 == PrimitiveType.DECIMAL128) continue;
