...
/**
 * Verifies that {@link RestIcebergBackend} inherits the shared
 ...
 */
class RestIcebergBackendTimeTravelTest {
    ...
    private Table table;
    private RestIcebergBackend backend;
    ...
    void setUp() {
        ...
        backend = new RestIcebergBackend() {
            @Override
