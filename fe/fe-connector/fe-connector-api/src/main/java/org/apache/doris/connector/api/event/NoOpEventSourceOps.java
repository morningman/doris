...
/** Backing impl for {@link EventSourceOps#NONE}. */
final class NoOpEventSourceOps implements EventSourceOps {
    ...
    public EventBatch poll(EventCursor cursor, int maxEvents, Duration timeout, EventFilter filter) {
        throw new UnsupportedOperationException("event source not configured");
    }
