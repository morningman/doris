...
public class ConnectorContextCacheDefaultsTest {
    ...
    @Test
    public void getOrCreateCacheThrows() {
        CacheLoader<String, Integer> loader = String::length;
        ConnectorMetaCacheBinding<String, Integer> binding =
                ConnectorMetaCacheBinding.builder("e", String.class, Integer.class, loader).build();
        Assertions.assertThrows(UnsupportedOperationException.class,
                () -> CONTEXT.getOrCreateCache(binding));
    }

    @Test
    public void invalidateAndInvalidateAllAreNoOp() {
        CONTEXT.invalidate(InvalidateRequest.ofCatalog());
