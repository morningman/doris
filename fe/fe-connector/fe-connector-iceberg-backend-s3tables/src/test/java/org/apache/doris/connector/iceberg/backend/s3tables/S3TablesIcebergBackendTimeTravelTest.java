...
/**
 * Verifies that {@link S3TablesIcebergBackend} inherits the shared
 ...
 */
class S3TablesIcebergBackendTimeTravelTest {
    ...
    private Table table;
    private S3TablesIcebergBackend backend;
    ...
    void setUp() {
        ...
        backend = new S3TablesIcebergBackend() {
            @Override
