...
JAVA_OPTS="-Dteamcity.enableStdErr=${enableStdErr}" ./run-regression-test.sh --teamcity --clean --run -parallel 5 -suiteParallel 2 -actionParallel 5 -g p1 -xd tpch_sf1_p1/tpch_sf1/nereids/
exit_flag=$?
