...
/** ServiceLoader entry point for the Aliyun DLF Paimon backend. */
public final class AliyunDlfPaimonBackendFactory implements PaimonBackendFactory {

    @Override
    public String name() {
        return AliyunDlfPaimonBackend.NAME;
    }

    @Override
    public PaimonBackend create() {
        return new AliyunDlfPaimonBackend();
    }
}
