...
/**
 * Verifies that {@link GlueIcebergBackend} inherits the shared
 ...
 */
class GlueIcebergBackendTimeTravelTest {
    ...
    private Table table;
    private GlueIcebergBackend backend;
    ...
    void setUp() {
        ...
        backend = new GlueIcebergBackend() {
            @Override
