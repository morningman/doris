...
/**
 * Verifies that {@link RestPaimonBackend} inherits the shared paimon
 ...
 */
class RestPaimonBackendRefOpsTest {
    ...
    private RestPaimonBackend backend;
