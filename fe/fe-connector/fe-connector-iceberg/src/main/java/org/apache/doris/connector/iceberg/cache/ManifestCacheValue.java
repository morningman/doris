...
/**
 * Cached manifest payload containing parsed files. Plugin-private port of
 * the legacy fe-core {@code org.apache.doris.datasource.iceberg.cache.ManifestCacheValue};
 * the bytes / shape are identical so that the cache semantics match
