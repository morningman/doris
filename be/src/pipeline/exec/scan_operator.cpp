...
ScanOperator::ScanOperator(OperatorTemplate *operator_template, doris::vectorized::VScanNode* scan_node)
...
Status ScanOperator::prepare(RuntimeState* state) {
    ...
    _scan_node->_input_tuple_desc = state->desc_tbl().get_tuple_descriptor(_scan_node->_input_tuple_id);
    _scan_node->_output_tuple_desc = state->desc_tbl().get_tuple_descriptor(_scan_node->_output_tuple_id);
