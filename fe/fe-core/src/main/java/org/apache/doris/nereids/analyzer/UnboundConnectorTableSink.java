...
public class UnboundConnectorTableSink<CHILD_TYPE extends Plan> extends UnboundBaseExternalTableSink<CHILD_TYPE> {
    ...
    // Static partition key-value pairs for INSERT OVERWRITE ... PARTITION (col='val', ...).
    // Empty when the user did not write a static-partition clause.
    ...
    /**
     * constructor with static-partition support.
     */
    public UnboundConnectorTableSink(List<String> nameParts,
                                     List<String> colNames,
                                     List<String> hints,
