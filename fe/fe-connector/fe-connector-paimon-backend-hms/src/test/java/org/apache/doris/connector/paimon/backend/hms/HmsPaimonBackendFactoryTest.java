...
class HmsPaimonBackendFactoryTest {
    ...
    void factoryDiscoveredViaServiceLoader() {
        ...
        boolean present = found.stream()
                .anyMatch(f -> f instanceof HmsPaimonBackendFactory);
        Assertions.assertTrue(present,
                "ServiceLoader did not find HmsPaimonBackendFactory; got: " + found);
    }

    @Test
    void factoryNameMatchesBackendName() {
        HmsPaimonBackendFactory f = new HmsPaimonBackendFactory();
