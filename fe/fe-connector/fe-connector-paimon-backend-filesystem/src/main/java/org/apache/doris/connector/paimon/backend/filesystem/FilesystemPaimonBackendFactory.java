...
/** ServiceLoader entry point for the Filesystem Paimon backend. */
public final class FilesystemPaimonBackendFactory implements PaimonBackendFactory {

    @Override
    public String name() {
        return FilesystemPaimonBackend.NAME;
    }

    @Override
    public PaimonBackend create() {
        return new FilesystemPaimonBackend();
    }
}
