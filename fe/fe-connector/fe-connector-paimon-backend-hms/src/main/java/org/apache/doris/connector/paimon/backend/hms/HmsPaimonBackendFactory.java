...
/** ServiceLoader entry point for the HMS Paimon backend. */
public final class HmsPaimonBackendFactory implements PaimonBackendFactory {

    @Override
    public String name() {
        return HmsPaimonBackend.NAME;
    }

    @Override
    public PaimonBackend create() {
        return new HmsPaimonBackend();
    }
}
