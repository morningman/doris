...
/** ServiceLoader entry point for the Hadoop Iceberg backend. */
public final class HadoopIcebergBackendFactory implements IcebergBackendFactory {

    @Override
    public String name() {
        return HadoopIcebergBackend.NAME;
    }

    @Override
    public IcebergBackend create() {
        return new HadoopIcebergBackend();
    }
}
