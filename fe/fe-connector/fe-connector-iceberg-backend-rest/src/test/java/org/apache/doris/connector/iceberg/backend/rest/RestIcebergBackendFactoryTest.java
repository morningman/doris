...
package org.apache.doris.connector.iceberg.backend.rest;
...
class RestIcebergBackendFactoryTest {
    ...
    void factoryDiscoveredViaServiceLoader() {
        ...
        boolean present = found.stream()
                .anyMatch(f -> f instanceof RestIcebergBackendFactory);
        Assertions.assertTrue(present,
                "ServiceLoader did not find RestIcebergBackendFactory; got: " + found);
    }

    @Test
    void factoryNameMatchesBackendName() {
        RestIcebergBackendFactory f = new RestIcebergBackendFactory();
