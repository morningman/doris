...
# after index.html add total time dimension, 
# get it from selectdb-qa/pipline_files/opensourceDoris_pipline/benchmark/clickbench/,
# no longer from https://benchmark.clickhouse.com/.
# rm 'index.html'
