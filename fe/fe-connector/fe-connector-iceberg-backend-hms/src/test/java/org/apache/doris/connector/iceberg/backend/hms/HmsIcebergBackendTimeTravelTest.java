...
/**
 * Verifies that {@link HmsIcebergBackend} inherits the shared
 ...
 */
class HmsIcebergBackendTimeTravelTest {
    ...
    private Table table;
    private HmsIcebergBackend backend;
