...
Status BitmapIndexReader::load(bool use_page_cache, bool kept_in_memory, int64_t* mem_footprint) {
    ...
    RETURN_IF_ERROR(_dict_column_reader->load(use_page_cache, kept_in_memory, mem_footprint));
    RETURN_IF_ERROR(_bitmap_column_reader->load(use_page_cache, kept_in_memory, mem_footprint));
    return Status::OK();
}
